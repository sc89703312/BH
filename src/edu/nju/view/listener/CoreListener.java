...
public class CoreListener implements MouseListener, ActionListener {
	...
	ChessBoardModelImpl chessBoardModel;
	...
	public void mouseClicked(MouseEvent e) {
		...
		if(e.getButton()==MouseEvent.BUTTON3){//右键相应雷格
			...
			if(ChessBoardModelImpl.judge){
			System.out.println("监听到了右键!!!!!!");
			...
			if(e.getButton()==MouseEvent.BUTTON1){//左键相应雷格
			   if(e.getClickCount()==2){//双击左键
				...
				if(e.getButton()==MouseEvent.BUTTON2){//点击滚轮键
